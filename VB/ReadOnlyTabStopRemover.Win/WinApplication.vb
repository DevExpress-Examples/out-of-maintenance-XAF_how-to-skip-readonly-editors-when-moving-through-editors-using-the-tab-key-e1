...
Namespace ReadOnlyTabStopRemover.Win
	Partial Public Class ReadOnlyTabStopRemoverWindowsFormsApplication
		...
		Private Sub ReadOnlyTabStopRemoverWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
